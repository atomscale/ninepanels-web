                ...
                <form @submit.prevent="onSubmit" class="space-y-6" action="#" method="POST">
                    ...
                    <div>
                        <button type="submit" @click="signUserUp()"
                            class="flex w-full justify-center rounded-md border border-transparent bg-blue-400 py-2 px-4 text-sm font-bold text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Sign
                            up</button>
                    </div>
                </form>
            </div>
