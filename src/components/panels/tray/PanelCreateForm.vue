  ...
  <div class="flex flex-col justify-between h-full pb-4">
    ...
    <div>
      ...
      <form @submit.prevent="onSubmit" class="space-y-4" action="#" method="POST">
        <div>
          <label :style="{'font-variant': 'small-caps'}" class="data-heading">Your panel</label>
          <div class="mt-1">
        ...
        <div>
          <label :style="{'font-variant': 'small-caps'}" class="data-heading">About your panel (optional)</label>
          <div class="mt-1">
