<template >
  ...
  <div class="flex h-auto">
    <textarea @input="updateLen()" v-model="localDescription" type="text" required="true"
      class="block resize-none h-80 w-full text-np-base appearance-none text-sm rounded-md border border-np-base px-2 py-1 placeholder-gray-400 shadow-sm focus:border-gray-500 focus:outline-none focus:ring-gray-500 " />
  </div>
