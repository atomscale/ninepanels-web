...
<template>
    <div class="flex flex-col h-full justify-between items-center">
        ...
        <img loading="eager" alt="screenshot of the Nine Panels main screen showing completed panels and the consistency grid" src="@/assets/cta_static.jpg" class="px-20 mt-2"/>
